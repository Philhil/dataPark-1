...
const input = fs.readFileSync('./contracts/ParKing.sol');
const output = solc.compile(input.toString(), 1);
const bytecode = output.contracts['ParKing'].bytecode;
const abi = JSON.parse(output.contracts['ParKing'].interface);
